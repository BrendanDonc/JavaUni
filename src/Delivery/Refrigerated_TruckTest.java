...
public class Refrigerated_TruckTest {
    ...
    @Test
    public void calcTruckTemp() throws DeliveryException, StockException {
        rTruck.addItem(iceCream, 50);
        double actualTemp = -5;
        assertEquals(actualTemp, rTruck.getTemp(), 0.1); // getTemp will need to get the lowest temperature from the
                                                         // items added
    }
    ...
    /*
     * Test 11: Checking the temperature of the truck is safe (ie. has not exceeded
     * either limit)
     */
    @Test(expected = StockException.class)
    ...
    /*
     * Test 12: Checking that at there is least 1 temperature-controlled item in
     * cargo
     */
    @Test
    ...
    /*
     * Test 17: Checking the truck has a refrigerated item before returning
     * temperature
     */
    @Test(expected = DeliveryException.class)
    ...
    /*
     * Test 18: Checking the truck has a refrigerated item before calculating the
     * cost
     */
    @Test(expected = DeliveryException.class)
