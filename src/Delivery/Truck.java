...
/**
 * An abstract Truck class, used for implementing Ordinary Truck and
 * Refrigerated Truck
 * 
...
public abstract class Truck {
     ...
     *             Exception thrown from Stock's subtractItem method
     * @author Brendan Doncaster
     */
     ...
     *             Refrigerated truck with no refrigerated item
     * @author Brendan Doncaster
     */
     ...
     * @throws DeliveryException
     *             Refrigerated Truck can't be calculated because it lacks a
     *             refrigerated item
     * @author Brendan Doncaster
     */
     ...
     * 
     * @param item
     *            Item to add to the cargo
     * @param amount
     *            Quantity of the item to add
     * @throws DeliveryException
     *             Item exceeds cargo space or temperature is invalid
     * @throws StockException
     *             Item attempts to add invalid amount
     * @author Brendan Doncaster
     */
     ...
     * 
     * @param string
     *            name of an Item to add to the cargo
     * @param amount
     *            Quantity of the item to add
     * @throws DeliveryException
     *             Item exceeds cargo space or temperature is invalid
     * @throws StockException
     *             Item's name is not found in the store
     * @author Brendan Doncaster
     */
