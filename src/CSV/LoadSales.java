...
public class LoadSales {
    ...
    /**
     * Takes the Stock created from the selected directory and subtracts the items
     * from the store and adds its price to the store's capital
     * 
     * @param file
     *            String format of the file directory of a CSV formated sales log
     * @throws CSVFormatException
     *             when fields in the csv are incorrect or missing, or the file
     *             doesn't exist
     * @throws StockException
     *             when the string for addItemName is invalid or the stock is an
     *             invalid subtraction
     * @throws IOException
     *             default exception throws
     * @see IOException
     */
     ...
     * 
     * @param file
     *            String format of the file directory of a CSV formatted sales log
     * @return Stock object version of the sales log
     * @throws CSVFormatException
     *             when fields in the csv are incorrect or missing, or the file
     *             doesn't exist
     * @throws StockException
     *             when the string for addItemName is invalid
     * @throws IOException
     *             default exception throws
     * @see IOException
     */
                    ...
                    if (item.length == 2) {
                        ...
                        try {
                            ...
                            throw new CSVFormatException(
                                    "Sale for item " + name + " on line " + currentLine + " has an invalid amount");
                        }
                        sale.addItemName(name, quantity);
                    } else {
                        throw new CSVFormatException(
                                "Sale on line " + currentLine + " does not have correct amount of fields(2)");
                    }
                }
