...
public class InitializeItems {
     ...
     * 
     * @param file
     *            String format of the file directory of all items to be initialized
     * @throws CSVFormatException
     *             when any of the item properties are incorrectly formatted or the
     *             file doesn't exist
     * @throws StockException
     *             when the item created isn't valid to add to a stock
     * @throws IOException
    ...
    /**
     * Reads the supplied file directory and returns a stock with all items
     * contained within the file with 0 quantity
     * 
     * @param file
     *            String format of the file directory of all items to be initialized
            ...
            try {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    if (item.length > 6 || item.length < 5) {
                        throw new CSVFormatException("Item property on line " + currentLine
                                + " does not have correct amount of fields(either 5 or 6)");
                    } else {
                        name = item[0];
                        ...
                        if (item.length == 6) {
                            try {
                                ...
                                throw new CSVFormatException(
                                        "Item with name '" + name + "' has an invalid temperature");
                            }
