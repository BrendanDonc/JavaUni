...
public class CSVTest {
	...
	public void test() throws CSVFormatException, StockException, DeliveryException, IOException {
		...
		LoadSales.LoadSales("testData/sales_log_1.csv");
		...
		LoadSales.LoadSales("testData/sales_log_2.csv");
		...
		LoadSales.LoadSales("testData/sales_log_3.csv");
		...
		LoadSales.LoadSales("testData/sales_log_4.csv");
