...
/**
 * The 'Stock' class is used to manipulate collections of items, and is used for
 * representing store inventory, stock orders, sales logs, and truck cargo.
 * 
 * @author Mary Millar
 *
 */
public class Stock {
     ...
     * 
     * This method takes into consideration if the item to be added already exists,
     * and updates the quantity accordingly.
     * 
     * @param item
     ...
     *             The exception thrown if attempting to add a negative amount of
     *             item to the store.
     */
     ...
     * 
     * @return An array of type Item representing all of the items in the current
     *         stock.
     */
     ...
     * 
     * @param stock
     *            The stock to be added to the current stock.
     * @throws StockException
     *             The exception inherited from addItem().
     */
    ...
    /**
     * A method that returns the sum of manufacturing costs of all the items
     * currently in the stock.
     * 
     * @return A double representing the total sum of the manufacturing costs in the
     *         current stock.
     */
    ...
    /**
     * A method that returns the sum of the sale prices of all the items currently
     * in the stock.
     * 
     * @return A double representing the total sum of the sale prices in the current
     *         stock.
     */
    ...
    /**
     * A method that returns a sorted list of all the items in the current stock
     * that must be temperature-controlled.
     * 
     * @return An array of type 'Item' representing all the 'cold' items in the
     *         current stock.
     */
    public Item[] getListCold() {
        ...
        List<Map.Entry<Item, Double>> listColds = new LinkedList<Map.Entry<Item, Double>>(unsortedColds.entrySet());
    ...
    /**
     * A method that returns an unsorted list of all the non-temperature-controlled
     * items in the current stock.
     * 
     * @return An array of type 'Item' representing all the 'ordinary' items in the
     *         current stock.
     */
    ...
    /**
     * A method that retrieves the lowest temperature of any item in the current
     * stock.
     * 
    ...
    /**
     * This method formats the information in the current stock into a 'manifest'
     * style (ie. [item],[quantity]).
     * 
     * @return A string representing a list that contains items in the current stock
     *         and their quantity.
     */
    ...
    /**
     * This method retrieves the quantity of the specified item in the current
     * stock.
     * 
     * @param item
     *            The name of the item.
     * 
     * @return An integer representing the amount of an item that is being held in
     *         the current stock.
     */
     ...
     * 
     * @throws StockException
     *             The exception thrown if either the item name or quantity is
     *             invalid.
     */
        ...
        if (stockArray.containsKey(item)) {
            ...
            if (origAmount >= subtractAmount) {
                ...
                throw new StockException(
                        "There was not enough of '" + item.getName() + "' to subtract from the stock.");
            }
        } else {
    ...
    /**
     * This method adds the quantity of an item (specified by its name) into the
     * store.
     * 
     * @param string
     *            The name of the item.
     ...
     * 
     * @throws StockException
     *             The exception thrown if there is not enough of an item to
     *             subtract.
     */
    ...
    /**
     * This method retrieves the total amount of items (ie. all their quantities) in
     * the current stock.
     * 
     * @return An integer representing the total amount of items in the current
     *         stock.
     */
     ...
     * 
     * @return An array of type 'Item' that represents all the items to be
     *         reordered.
     */
    ...
    /**
     * This method determines if the removal of an item from a stock will be
     * successful or not.
     * 
     * @param item
     *            The name of the item.
     ...
     * 
     * @return A boolean representing if the removal of an item from a stock will be
     *         successful (true) or not (false).
     * 
     * @throws StockException
     *             The exception thrown if there was not enough of an item to be
     *             subtracted, or if the store did not contain the item.
     */
        ...
        if (stockArray.containsKey(item)) {
            ...
            if (origAmount >= quantity) {
                ...
                StockException badItemAmount = new StockException(
                        "There was not enough of item '" + item.getName() + "' to sell.");
                throw badItemAmount;
            }
        } else {
            success = false;
    ...
    /**
     * This method determines if the removal of an 'outside' stock from the current
     * stock will be successful or not.
     * 
     * @param stock
     *            The name of the 'outside' stock.
     * 
     * @return A boolean representing if the removal of the 'outside' stock will be
     *         successful (true) or not (false).
     * 
     * @throws StockException
     *             The exception thrown if there was not enough of an item to be
