...
/**
 * The 'Store' class holds an instanced version of the client's store, which
 * essentially keeps the contents of the store universal.
 * 
 * It contains information regarding the store's stock, current capital, and
 * name.
 * 
 * 
 * @author Mary Millar
...
public final class Store {
    ...
    /**
     * A constructor that holds the store's name, starting capital, and an empty
     * stock.
     */
    private Store() {
        this.name = "SuperMart";
     ...
     * 
     * @param inputInv
     *            The stock to be set as the current stock.
     * @throws StockException
     *             The exception inherited from addStock().
     */
     ...
     * 
     * @param raiseAmount
     *            The amount that capital of the store is to be raised by.
     */
     ...
     * 
     * @param lowerAmount
     *            The amount that the capital of the store is to be lowered by.
     */
    ...
    /**
     * This method retrieves the current capital amount from its integer form and
     * turns it into a 'dollar' format (eg. $100,000.00)
     * 
